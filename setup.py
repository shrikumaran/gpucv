...
setup(
    ...
    package_data={'gpucv': ['gpucv.so']},
    include_package_data=True,

    description="Run image processing algos on your GPU",
    ...
    dependency_links=['https://github.com/pybind/pybind11/tarball/master',
    ...
    ext_modules=[CMakeExtension('gpucv')],
